...
import org.apache.spark.sql.functions.{col, dense_rank, desc, max, rank, to_date}

object Day29WindowFunctions extends App {

  println("Chapter 7: Window functions!")
  val spark = SparkUtilities.getOrCreateSpark("Sandbox for window functions")

...
object WebScraping extends App {

  println("Let's learn about web scraping!")

  val url = "https://en.wikipedia.org/wiki/Riga"
  //https://www.lihaoyi.com/post/ScrapingWebsitesusingScalaandJsoup.html

  //html is just text, but we want to parse it since it is a structured text
  ...
  //you need to know what kind of element you want to find

...
object Day32PipelineExample extends App {
  ...
  //the big idea is that instead of writing multiple nested loops by hand and trying different combinations
  ...
  //basically our grid will check 2*3*2 = 12 different combinations of these parameters

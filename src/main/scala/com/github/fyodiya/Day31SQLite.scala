...
//  If this connection succeeds, you’re good to go.
  //  Let’s go ahead and read the DataFrame from the SQL table:
...
AS flight_info"""
  ...
  //TODO how would you add extra tables to already existing SQL database? probably solution involves append
